            ...
            <div class="p-px bg-gradient-to-br from-purple-500/30 via-slate-800 to-amber-500/30 rounded-[3rem] shadow-2xl">
                <div class="bg-slate-950/80 backdrop-blur-3xl p-10 sm:p-16 rounded-[2.9rem]">
                    ...
                    <form action="{{ route('revisions.store') }}" method="POST" class="space-y-12">
                        ...
                        <!-- Contact Section -->
                        <div class="space-y-8">
                            <h3 class="flex items-center gap-3 text-sm font-black text-slate-100 uppercase tracking-[0.2em]">
                            ...
                            <div class="grid grid-cols-1 md:grid-cols-2 gap-8">
                                <div class="space-y-2">
                                    <label class="text-[10px] font-black uppercase tracking-widest text-slate-500 ml-1">Nom Complet</label>
                                    <input type="text" name="client_nom" required placeholder="Votre Nom" class="w-full py-4 px-6 bg-slate-900 border border-slate-800 rounded-2xl text-white text-sm focus:ring-2 focus:ring-purple-500/20 focus:border-purple-500 transition">
                                </div>
                                <div class="space-y-2">
                                    <label class="text-[10px] font-black uppercase tracking-widest text-slate-500 ml-1">Téléphone</label>
                                    <input type="tel" name="client_telephone" required placeholder="+228..." class="w-full py-4 px-6 bg-slate-900 border border-slate-800 rounded-2xl text-white text-sm focus:ring-2 focus:ring-purple-500/20 focus:border-purple-500 transition">
                                </div>
                                <div class="space-y-2 md:col-span-2">
                                    <label class="text-[10px] font-black uppercase tracking-widest text-slate-500 ml-1">Email (Pour la notification)</label>
                                    <input type="email" name="client_email" placeholder="votre@email.com" class="w-full py-4 px-6 bg-slate-900 border border-slate-800 rounded-2xl text-white text-sm focus:ring-2 focus:ring-purple-500/20 focus:border-purple-500 transition">
                                </div>
                            </div>
                        </div>
