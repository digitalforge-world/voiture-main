                    ...
                    <div class="p-10 space-y-8">
                        ...
                        <div class="pt-4">
                            <form action="{{ route('rental.book', $car->id) }}" method="POST" class="space-y-4">
                                ...
                                <div class="space-y-3 pt-2 border-t border-slate-900/50">
                                    <input type="text" name="client_nom" required placeholder="Votre Nom Complet" class="w-full bg-slate-900 border border-slate-800 rounded-xl px-3 py-3 text-xs text-white placeholder-slate-600 focus:outline-none focus:ring-2 focus:ring-amber-500/20 focus:border-amber-500 transition">
                                    <input type="tel" name="client_telephone" required placeholder="Téléphone +228..." class="w-full bg-slate-900 border border-slate-800 rounded-xl px-3 py-3 text-xs text-white placeholder-slate-600 focus:outline-none focus:ring-2 focus:ring-amber-500/20 focus:border-amber-500 transition">
                                    <input type="email" name="client_email" placeholder="Email (Optionnel)" class="w-full bg-slate-900 border border-slate-800 rounded-xl px-3 py-3 text-xs text-white placeholder-slate-600 focus:outline-none focus:ring-2 focus:ring-amber-500/20 focus:border-amber-500 transition">
                                </div>
