                        ...
                        @auth
                            <div class="flex items-center gap-2 lg:gap-3">
                                @if(Auth::user()->is_admin)
                                    <a href="{{ route('admin.dashboard') }}" class="px-2 lg:px-4 py-1.5 lg:py-2 text-[10px] lg:text-sm font-semibold transition bg-transparent border border-amber-500/50 text-amber-500 rounded-xl hover:bg-amber-500/10">Admin</a>
                                @endif
                                <a href="{{ route('dashboard') }}" class="flex items-center gap-1.5 lg:gap-2 px-3 lg:px-4 py-2 text-[10px] lg:text-sm font-semibold text-white transition bg-amber-600 rounded-xl hover:bg-amber-500 shadow-lg shadow-amber-900/20">
