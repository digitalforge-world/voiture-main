                    ...
                    <div class="space-y-2">
                        ...
                        <div class="relative group">
                            <input id="email" name="email" type="email" autocomplete="email" required placeholder="exemple@mail.com" 
                                class="w-full py-4 pl-12 pr-4 bg-slate-900 border border-slate-800 rounded-2xl text-white text-sm focus:ring-2 focus:ring-amber-500/20 focus:border-amber-500 transition group-hover:border-slate-700 @error('email') border-rose-500 @enderror" value="{{ old('email') }}">
                    ...
                    <div class="space-y-2">
                        ...
                        <div class="relative group">
                            <input id="password" name="password" type="password" autocomplete="current-password" required placeholder="••••••••"
                                class="w-full py-4 pl-12 pr-4 bg-slate-900 border border-slate-800 rounded-2xl text-white text-sm focus:ring-2 focus:ring-amber-500/20 focus:border-amber-500 transition group-hover:border-slate-700 @error('password') border-rose-500 @enderror">
