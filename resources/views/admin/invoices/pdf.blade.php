...
<body>
 ...
 <table class="items-table">
  ...
  <tbody>
   <tr>
    ...
    <td>1</td>
    <td>{{ number_format($invoice->amount_total, 2, ',', ' ') }} FCFA</td>
    <td>{{ number_format($invoice->amount_total, 2, ',', ' ') }} FCFA</td>
   </tr>
  </tbody>
 </table>
 ...
 <div class="total">
  <div style="margin-bottom: 10px;">Sous-total: {{ number_format($invoice->amount_total, 2, ',', ' ') }} FCFA</div>
  <div style="color: #f59e0b;">TOTAL: {{ number_format($invoice->amount_total, 2, ',', ' ') }} FCFA</div>
 </div>
