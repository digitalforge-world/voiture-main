...
class Location extends Model
{
    ...
    protected $fillable = [
        'user_id','reference','tracking_number','voiture_location_id','date_debut','date_fin','date_debut_reelle','date_fin_reelle','montant_location','caution','frais_supplementaires','montant_total','statut','etat_depart','kilometrage_depart','etat_retour','kilometrage_retour','commentaires'
    ];
